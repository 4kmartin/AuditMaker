...
custom_item_type_lookup = {
    ...
    "AUDIT_POWERSHELL": None,
    "AUDIT_FILEHASH_POWERSHELL":None,
    "AUDIT_IIS_APPCMD":None,
    "AUDIT_ALLOWED_OPEN_PORTS":None,
    "AUDIT_DENIED_OPEN_PORTS":None,
    "AUDIT_PROCESS_ON_PORT":None,
    "AUDIT_USER_TIMESTAMPS":None,
    "BANNER_CHECK":None,
    "CHECK_ACCOUNT":None,
    "CHECK_LOCAL_GROUP":None,
    "ANONYMOUS_SID_SETTING":None,
    "SERVICE_POLICY":None,
    "GROUP_MEMBERS_POLICY":None,
    "USER_GROUPS_POLICY":None,
    "USER_RIGHTS_POLICY":None,
    "FILE_CHECK":None,
    "FILE_VERSION":None,
    "FILE_PERMISSIONS":None,
    "FILE_AUDIT":None,
    "FILE_CONTENT_CHECK":None,
    "FILE_CONTENT_CHECK_NOT":None,
    "REG_CHECK":None,
    "REGISTRY_SETTING":None,
    "REGISTRY_PERMISSIONS":None,
    "REGISTRY_AUDIT":None,
    "REGISTRY_TYPE":None,
